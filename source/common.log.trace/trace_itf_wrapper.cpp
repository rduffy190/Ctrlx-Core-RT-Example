...
namespace common
{
  namespace log
  {
    namespace trace
    {
      ...
      TraceInstance::TraceInstance(TraceConnect& traceConnect, std::uint32_t infoCode, std::uint32_t warningCode, std::uint32_t errorCode, const std::string baseEntity) : m_infoCode(infoCode), m_warningCode(warningCode), m_errorCode(errorCode), m_baseEntity(baseEntity), m_traceConnect(traceConnect)
      {
