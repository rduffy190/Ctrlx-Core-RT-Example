...
//! @brief This macro declares, defines and creates a global extern object of class @ref common::log::trace::TraceInstance.
//!
//! @param[in]    instanceIdentifier   Type: LABEL. Instance identifier which acts also as object name.
...
//!
//! @param[in]    unitIdentifier   Type: LABEL. Unit identifier the trace name is gotten for.
...
//!
//! @param[in]    unitIndexedIdentifier   Type: LABEL. Unit identifier the trace enabling state is gotten for.
  ...
  namespace log
  {
    namespace trace
    {
      ...
      public:
        ...
        TraceInstance(TraceConnect& traceConnect, std::uint32_t infoCode, std::uint32_t warningCode, std::uint32_t errorCode, const std::string baseEntity);
        ...
        //! Origin which corresponds to the snap name the trace instance is running in.
