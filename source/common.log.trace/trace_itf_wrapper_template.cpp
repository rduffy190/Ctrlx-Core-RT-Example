...
// ---------------------------------------------------------------------------
// Definition of common part - has to be done using whether standard or multiple indexed trace units
// ---------------------------------------------------------------------------
...
DEFINITION_TRACE_INSTANCE(SYSTEMHANDLER, TRACE_MAIN_DIAGNOSIS_CODE_MESSAGE, TRACE_MAIN_DIAGNOSIS_CODE_WARNING, TRACE_MAIN_DIAGNOSIS_CODE_ERROR, "system");  // Definition and creation of the trace instance object.
...
DEFINITION_TRACE_INSTANCE(ETHERCAT, TRACE_MAIN_DIAGNOSIS_CODE_MESSAGE, TRACE_MAIN_DIAGNOSIS_CODE_WARNING, TRACE_MAIN_DIAGNOSIS_CODE_ERROR, "ethercat");  // Definition and creation of the trace instance object.
...
DEFINITION_TRACE_UNIT_INDEXED(ETHERCAT, SLAVE, 10, common::log::trace::TRACE_ENABLING_STATE_NONE);  // Definition and creation of another indexed trace unit object with 10 units.
