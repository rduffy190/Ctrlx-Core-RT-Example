...
#define SCHED_TRACE_ENTITY "sdk.automation.scheduler"
...
#define RT_TRACE_ERR(text, ...) { \
  ...
  { \
    ...
    private:
      const std::string m_traceName = "Example";
      ...
      common::log::trace::EnablingState m_traceEnablingState = {true, true, true}; // message, warning, error
    };
  }
}
